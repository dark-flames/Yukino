...
pub struct Foo<'r> {
    inner: std::borrow::Cow<'r, FooInner>,
...
impl<'r> Foo<'r> {
    ...
    pub fn set_string(&mut self, value: String) -> &mut Self {
        self.inner.to_mut().string = value;
        self
    }
    ...
    pub fn set_integer(&mut self, value: u32) -> &mut Self {
        self.inner.to_mut().integer = value;
        self
    }
