#![allow(unknown_lints)]
#[derive(Clone)]
pub struct FooInner<'t> {
    integer: u32,
    int16: i16,
    list: Vec<String>,
    map: std::collections::HashMap<String, String>,
    string: String,
    _repository_life_time_marker: std::marker::PhantomData<&'t ()>,
}
impl<'t> FooInner<'t> {
...
impl<'t> yukino::Entity<'t> for FooInner<'t> {
    type Proxy = Foo<'t>;
...
pub struct Foo<'t> {
    ...
    repository: &'t yukino::repository::Repository<'t, FooInner<'t>>,
}
impl<'t> yukino::EntityProxy<'t, FooInner<'t>> for Foo<'t> {
    ...
    fn get_repository(&self) -> &'t yukino::repository::Repository<'t, FooInner<'t>>
    where
        Self: Sized,
    {
        self.repository
