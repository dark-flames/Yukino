...
#[derive(ToTokens)]
pub enum TableType {
    /// Table generated by model, parameter is the path of model
    NormalModelTable(String),
    /// Table generated by association, parameter is the path of owner side model and attachment side
...
#[derive(ToTokens)]
pub enum ColumnType {
    /// Column generated by field of model, parameter is the field name
    NormalColumn(String),
